...
const Reels: React.FC = () => {
  ...
  const mockReels: Reel[] = [
    ...
    {
      id: '2',
      authorName: 'João Tech',
      description: 'Testando o novo smartphone mais esperado do ano! Vale cada centavo? 📱✨',
      videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4',
      category: 'Tecnologia',
      likes: 342,
      comments: 67,
      timestamp: '4h',
      productName: 'Smartphone Pro Max 2024',
      currentPrice: 2499.90,
      promotionalPrice: 1999.90,
      storeName: 'TechStore'
    },
    {
      id: '3',
      authorName: 'Ana Style',
      description: 'Look do dia com essa combinação perfeita! Vocês amaram? 💕',
      videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
      category: 'Moda',
      likes: 89,
      comments: 12,
      timestamp: '6h',
      productName: 'Conjunto Casual Primavera',
      currentPrice: 179.90,
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-4 text-white">
                  ...
                  <div className="flex items-center mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-300">{reel.timestamp}</p>
                    </div>
                  </div>
